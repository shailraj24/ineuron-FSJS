...
// let newarr = new Array("raj", "shailraj", "mitraj");
// console.log(newarr);
...
// let nam2 = [7, 8, 9, 1];
// console.log(nam.concat(nam, nam1, nam2));
...
// console.log(asqr.reverse().map(Math.sqrt));
...
// function myRole (name , role) {
// var myRole = function (name , role) {

//   switch (role) {
//     case "admin":
//       return `i ${name} have access of all things`;
//       break;
//     case "subadmin":
//       return `i ${name} have access of create and delte courses`;
//       break;
//     case "testadmin":
//       return `i ${name} have access of create and delete test`;
//       break;

//     default :
//       return `${name} is temerory user`;
//       break;
//   }
// }

// console.log(myRole("raj","admin"));
// console.log(myRole("Shailra","subadmin"));
